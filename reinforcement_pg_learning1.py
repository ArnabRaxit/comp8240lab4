# -*- coding: utf-8 -*-
"""
Based on Reinforcement Learning (DQN) tutorial
=====================================
...
outf = './Output'
previous_state_dict = './policy_net_pg_episode_4350.pth'
...
if previous_state_dict != '':
    policy_net.load_state_dict(torch.load(previous_state_dict, map_location=lambda storage, loc: storage))
